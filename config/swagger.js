...
// Función para crear la configuración de Swagger dinámicamente
const createSwaggerConfig = (port) => {
  // Función para determinar la URL base dinámicamente
  const getBaseUrl = (port) => {
    // Render automáticamente expone RENDER_EXTERNAL_URL
    ...
    // Fallback para desarrollo local - usar puerto dinámico
      ...
      servers: [
        {
          ...
          description: process.env.NODE_ENV === 'production' 
            ...
            : `Servidor de desarrollo (Puerto: ${port})`
        }
      ],
      components: {
        securitySchemes: {
